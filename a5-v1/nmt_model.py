...
class NMT(nn.Module):
    ...
    def forward(self, source: List[List[str]], target: List[List[str]]) -> torch.Tensor:
        ...
        enc_hiddens_char, dec_init_state = self.encode(source_padded_chars,source_lengths)
        enc_masks = self.generate_sent_masks(enc_hiddens_char,source_lengths)
        combined_outputs = self.decode(enc_hiddens_char, enc_masks, dec_init_state, target_padded_chars)
